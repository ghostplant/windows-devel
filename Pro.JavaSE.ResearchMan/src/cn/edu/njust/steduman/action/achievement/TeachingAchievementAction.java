 ...
 * @author zyz
 */
public class TeachingAchievementAction extends GlobalActionSupport {
    ...
    public List getTeachers() {
        ...
        Iterator iterator;
        personMap = (TreeMap) SessionUtil.getSession("Teaching_personMap");
        if (personMap != null) {
    ...
    public String addPerson() {
        ...
        SessionUtil.setSession("Teaching_personMap", personMap);
        rank = teacherName = "";
        return SUCCESS;
    }

    public String delAll() {
        SessionUtil.setSession("Teaching_personMap", null);
        personMap = null;
        return SUCCESS;
    }
