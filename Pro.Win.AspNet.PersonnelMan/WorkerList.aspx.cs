...
public partial class WorkerList : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DownloadList.DataSource = new SqlServer().GetPageView("SELECT [name],[id] FROM [user]", "user", PageSize, page, prevPage, lbPage, lbTotal, nextPage);
    ...
    protected void prevPage_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("WorkerList.aspx?page=" + Page.ToString());
    }
