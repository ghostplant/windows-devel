...
CRITICAL_SECTION  crtSec;							//ÃÌº””Ôæ‰
...
void account(const char* file)
{
	...
	InitializeCriticalSection(&crtSec);					//ÃÌº””Ôæ‰
	...
	DeleteCriticalSection(&crtSec);						//ÃÌº””Ôæ‰
...
//get info froam para
	...
	do {
		...
		EnterCriticalSection(&crtSec);					//ÃÌº””Ôæ‰
...
//critical_section  end
		LeaveCriticalSection(&crtSec);					//ÃÌº””Ôæ‰
