...
///////////////////////////////////////////////////////////////////////
		static int sign[MAX_THREAD_NUM]={0}, turn = 1;	//Ìí¼ÓÓï¾ä
		sign[m_serial]=1;				//Ìí¼ÓÓï¾ä
		while (sign[3-m_serial])			//Ìí¼ÓÓï¾ä
			if (turn==3-m_serial) {			//Ìí¼ÓÓï¾ä
				sign[m_serial]=false;		//Ìí¼ÓÓï¾ä
				while (turn==3-m_serial);	//Ìí¼ÓÓï¾ä
				sign[m_serial]=true;		//Ìí¼ÓÓï¾ä
			}					//Ìí¼ÓÓï¾ä
	...
	//critical_section  end
		turn=3-m_serial;				//Ìí¼ÓÓï¾ä
		sign[m_serial]=0;				//Ìí¼ÓÓï¾ä
///////////////////////////////////////////////////////////////////////
		counter++;
