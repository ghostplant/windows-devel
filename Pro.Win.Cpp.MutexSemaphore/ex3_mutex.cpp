...
void account(const char* file)
{
	...
	HANDLE hMutex = CreateMutex(NULL,FALSE,"MyMutex");			//ÃÌº””Ôæ‰
...
//get info froam para
	...
	HANDLE hThisMutex = OpenMutex(MUTEX_ALL_ACCESS,FALSE,"MyMutex");	//ÃÌº””Ôæ‰
	...
	do {
		...
		WaitForSingleObject(hThisMutex,-1);				//ÃÌº””Ôæ‰
...
//critical_section  end
		ReleaseMutex(hThisMutex);					//ÃÌº””Ôæ‰

		counter++;
	} while ( (accnt == 0) && (counter<10)); 

	CloseHandle(hThisMutex);						//ÃÌº””Ôæ‰
