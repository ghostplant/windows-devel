...
void account(const char* file)
{
	...
	HANDLE hEvent=CreateEvent(0,0,FALSE,"MutexEvent");			//ÃÌº””Ôæ‰
	...
	SetEvent(hEvent);								//ÃÌº””Ôæ‰
	wait_for_all = WaitForMultipleObjects(n_thread,h_Thread,TRUE, -1);

	CloseHandle(hEvent);							//ÃÌº””Ôæ‰
...
//get info froam para
	...
	HANDLE hThisEvent=OpenEvent(EVENT_ALL_ACCESS,FALSE,"MutexEvent");	//ÃÌº””Ôæ‰
	...
	do {
		...
		WaitForSingleObject(hThisEvent,-1);				//ÃÌº””Ôæ‰
...
//critical_section  end
		SetEvent(hThisEvent);						//ÃÌº””Ôæ‰
		counter++;
	} while ( (accnt == 0) && (counter<10)); 

	CloseHandle(hThisEvent);						//ÃÌº””Ôæ‰
