...
create_admin_section (void)
{
  ...
  menu = g_menu_new ();
  g_menu_append (menu, _("Switch Account…"), "indicator.switch-to-greeter");
...
static void
on_switch_user_activated (GSimpleAction * a      G_GNUC_UNUSED,
                    GVariant      * param  G_GNUC_UNUSED,
                    gpointer        gself)
{
  //indicator_session_actions_about (get_backend_actions(gself));
  gchar *argv[]={"gdmflexiserver", NULL};
...
init_gactions (IndicatorSessionService * self)
{
  ...
  GActionEntry entries[] = {
    { "switch-user",            on_switch_user_activated     },
